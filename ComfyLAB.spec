...
a = Analysis(
    ...
    excludes=[
        ...
        'comfylab.blocks.script_sage',
        'comfylab.blocks.script_maxima',
        'comfylab.blocks.script_powershell',
        'comfylab.blocks.script_csharp',
        'comfylab.blocks.devices',
        'tests',
        'frontend/node_modules',
        # Exclude accidental math CAS and documentation/build tools
        'sage',
        'sagemath',
        'cypari2',
        'sphinx',
